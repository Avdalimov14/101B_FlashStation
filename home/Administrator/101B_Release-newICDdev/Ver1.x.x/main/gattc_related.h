...
static const uint8_t bb_measurements_characteristicUUID[16] = {0xe7, 0x7e, 0x06, 0x9b, 0x9d, 0xf9, 0x0f, 0xb3, 0xf0, 0x4a, 0x75, 0x09, 0x84, 0x57, 0x0d, 0x22};
...
static const uint8_t bb_time_characteristicUUID[16] = {0x4a, 0x4d, 0x88, 0x4f, 0x39, 0x1e, 0x64, 0xb5, 0xd2, 0x4b, 0x29, 0xbe, 0x7d, 0x82, 0xed, 0xea};
static uint8_t bb_writeToBiobeatProfile[13] = {1,95,1,150 ,70,4,200, 0,70, 0,120, 0,80};
...
#define MAX_OPEN_CONN_ATT 1


// Gatt Client related defines
static const char remote_device_name[] = "ESP_GATTS_BB_DEMO"; // remote is BioBeat's device
extern uint8_t bbBtMacAddrs[MAC_SIZE];
extern bool gattc_conn;// = false;
static bool get_server = false;
static esp_gattc_char_elem_t *char_elem_result   = NULL;
static esp_gattc_descr_elem_t *descr_elem_result = NULL;
extern uint8_t openBleConnAttempts;// = 0;
extern bool openBleConnection;// = false;
static bool registeredToNotify = false;
extern uint8_t validMeasurementsCounter;
...
static esp_bt_uuid_t remote_filter_time_uuid = {
    .len = ESP_UUID_LEN_128,
};
...
struct gattc_profile_inst {
    ...
    uint16_t measurements_desc_handle;

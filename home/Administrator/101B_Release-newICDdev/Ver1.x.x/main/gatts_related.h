...
#define GATTS_WRITE_CHAR_UUID_A      0x2A90 // Last Name
#define GATTS_CONTROL_CHAR_UUID_A      0x2A9F // User Control Point
//#define GATTS_DESCR_UUID_TEST_A     0x3333
#define GATTS_NUM_HANDLE_TEST_A     10 // may be 8 but who care
...
static uint32_t N_REC_IN_CHAR = 16; //N_REC_IN_CHAR must not be = 3!!!
static uint32_t MAX_CHAR_LENGTH = N_REC_IN_CHAR * 7;

// Gatt Server related vars and declarations
extern bool advertisingOn;// = false;
...
extern uint8_t simulatorMacAddress[MAC_SIZE];
extern bool sim_conn; // = false;
extern bool simulatorDevice; //= true


//static uint8_t notifyCharValue[23] = {0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 91, 95, 100, 80, 0xAA, 0xBB, 0xCC, 0xDD, 0xEE, 0xFF, 11};
extern uint8_t indicateCharValue[16*9]; // MAX_CHAR_LENGTH = N_REC_IN_CHAR * NUMERIC_BLE_BUFF_SIZE
extern uint8_t writeCharValue[9 * 7];
extern uint8_t controlCharValue[20];
static esp_gatt_char_prop_t indicateCharProperty = 0;
static esp_gatt_char_prop_t writeCharProperty = 0;
static esp_gatt_char_prop_t controlCharProperty = 0;
...
static esp_attr_value_t gatts_controlCharValue =
{
    .attr_max_len = GATTS_DEMO_CHAR_VAL_LEN_MAX,
    .attr_len     = sizeof(controlCharValue),
    .attr_value   = controlCharValue,
};

static uint8_t adv_config_done = 0;
static bool advConfigDone = false;
...
struct gatts_profile_inst { // x_propert and x_perm is not in use.
	...
	esp_gatt_perm_t control_char_perm;
	esp_gatt_char_prop_t control_char_property;

...
public:
    ...
    */
    ...
    // ISO14443A functions
    bool inListPassiveTarget(bool noResponse);
    bool readPassiveTargetID(uint8_t cardbaudrate, uint8_t *uid, uint8_t *uidLength, uint16_t timeout = 1000, bool inlist = true);
